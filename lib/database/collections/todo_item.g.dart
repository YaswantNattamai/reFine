...
extension TodoItemQueryFilter
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> textEqualTo(
    String value, {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> textGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> textLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> textBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> textStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> textEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> textContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> textMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> textIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'text',
        value: '',
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterFilterCondition> textIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'text',
        value: '',
...
extension TodoItemQuerySortBy on QueryBuilder<TodoItem, TodoItem, QSortBy> {
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> sortByText() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'text', Sort.asc);
    });
  }

  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> sortByTextDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoItemQuerySortThenBy
  ...
  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> thenByText() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'text', Sort.asc);
    });
  }

  QueryBuilder<TodoItem, TodoItem, QAfterSortBy> thenByTextDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'text', Sort.desc);
    });
  }
...
extension TodoItemQueryWhereDistinct
  ...
  QueryBuilder<TodoItem, TodoItem, QDistinct> distinctByText(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TodoItemQueryProperty
  ...
  QueryBuilder<TodoItem, String, QQueryOperations> textProperty() {
    return QueryBuilder.apply(this, (query) {
