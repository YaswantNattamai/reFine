...
void _todoListAttach(IsarCollection<dynamic> col, Id id, TodoList object) {
  object.id = id;
  object.items.attach(col, col.isar.collection<TodoItem>(), r'items', id);
}
...
extension TodoListQueryFilter
  ...
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> titleEqualTo(
    String value, {
  ...
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> titleGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> titleLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> titleBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> titleStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> titleEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> titleContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> titleMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> titleIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'title',
        value: '',
  ...
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> titleIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'title',
        value: '',
...
extension TodoListQueryLinks
    on QueryBuilder<TodoList, TodoList, QFilterCondition> {
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> items(
      FilterQuery<TodoItem> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'items');
    });
  }

  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> itemsLengthEqualTo(
      int length) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> itemsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'items', 0, true, 0, true);
    });
  }

  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> itemsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'items', 0, false, 999999, true);
    });
  }

  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> itemsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TodoList, TodoList, QAfterFilterCondition> itemsLengthBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension TodoListQuerySortBy on QueryBuilder<TodoList, TodoList, QSortBy> {
  QueryBuilder<TodoList, TodoList, QAfterSortBy> sortByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<TodoList, TodoList, QAfterSortBy> sortByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TodoListQuerySortThenBy
  ...
  QueryBuilder<TodoList, TodoList, QAfterSortBy> thenByTitle() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.asc);
    });
  }

  QueryBuilder<TodoList, TodoList, QAfterSortBy> thenByTitleDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'title', Sort.desc);
    });
  }
...
extension TodoListQueryWhereDistinct
  ...
  QueryBuilder<TodoList, TodoList, QDistinct> distinctByTitle(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TodoListQueryProperty
  ...
  QueryBuilder<TodoList, String, QQueryOperations> titleProperty() {
    return QueryBuilder.apply(this, (query) {
